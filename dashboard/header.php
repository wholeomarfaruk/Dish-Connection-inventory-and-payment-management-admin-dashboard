        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        <li class="<?php echo $currentpage == 'dashborad' ? 'active' : ''; ?>">
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="purchaselist.php">Collectors Collection</a></li>
                                <li><a href="cashcollection.php">Cash Collection</a></li>
                                <li><a href="purchaselist.php">Bill List</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="customerlist.php">Client List</a></li>
                                <li><a href="addclient.php">Add Client </a></li>
                                <li><a href="addcustomer.php">Client History</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/users1.svg" alt="img"><span>
                                    Collectors</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="userlists.php">Collectors List</a></li>
                                <li><a href="userlists.php">Collectors Route</a></li>
                                <li><a href="newuser.php">Collectors History</a></li>
                                <li><a href="newuser.php">New Collector</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/places.svg" alt="img"><span>
                                    Route</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="manageroute.php">Manage Route</a></li>
                                <li><a href="addnewroute.php">Add New Route</a></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="roadarea.php">Road</a></li>
                                <li><a href="localityarea.php">Locality</a></li>
                                <li><a href="villarea.php">Village</a></li>
                                <li><a href="psarea.php">Police Station</a></li>
                            </ul>
                        </li>
