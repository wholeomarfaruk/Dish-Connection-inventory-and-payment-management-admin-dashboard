...
// page title 
$pagetitle = "Add New Locality - Dashboard"; 
$currentpage = "newlocality"; 
...
<div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Police Locality List</h4>
                        <h6>Manage your Locality</h6>
                    </div>
                    <div class="page-btn">
                        <a href="javascript:void(0);" class="btn btn-added addnewarea" id="addnewarea">
                            <img src="assets/img/icons/plus.svg" alt="img" class="me-2">Add Locality
                        </a>
                    </div>
                </div>
