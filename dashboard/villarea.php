...
// page title 
$pagetitle = "Add New Village - Dashboard"; 
$currentpage = "newvill"; 
...
<div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Police Village List</h4>
                        <h6>Manage your Village</h6>
                    </div>
                    <div class="page-btn">
                        <a href="javascript:void(0);" class="btn btn-added addnewarea" id="addnewarea">
                            <img src="assets/img/icons/plus.svg" alt="img" class="me-2">Add Police Station
                        </a>
                    </div>
                </div>
